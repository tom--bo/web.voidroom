...
$result = mysql_query('SELECT subject,week_day,period,building_no,room_no FROM roooms_honkyan WHERE week_day = "'.$_POST['weekday'].'" and period="'.$_POST['period'].'" '.$building_str);
