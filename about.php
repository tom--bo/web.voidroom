...
<body>
  ...
  <div data-role="content">
    ...
    <p> [サイトについて]
    <br>このサイトは情報理工学科3年@tom__bo, @n0n0kiti, @Akhr5884によって運営されています。画像提供は@kimasoiaさんでした。</p>
    <p>[注意]
    <br>このサイトはシラバスに指定されていない教室を表示するだけのもので、<b>休講情報等は反映していません</b>。このサイトによって、発生した問題には一切責任を持ちませんので、参考程度にご利用ください。
    <br>52号館は別館の52号館に対応していますが、58号館,63号館の3Fの空き状況には対応してません。</p>
